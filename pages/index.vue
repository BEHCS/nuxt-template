<template>
  <div class="bg-grayish-white-1 relative">
    ...
    <div class="absolute h-screen w-2/3 top-0 right-0">
      <div class="flex h-full w-full">
        <div class="my-auto w-full">
          <div class="flex flex-col">
            <div class="text-4x1 font-poppins text-grey-800">
              <span class="font-thin"> Welcome to </span>
              <span class="font-semibold">BehCS's Page</span>
              <span class="text-6xl text-lead-yellow">.</span>
            </div>
            <div class="font-thin font-sans text-grey-700 text-left -mt-5">
